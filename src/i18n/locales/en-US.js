...
export default {
    ...
    dashboard: {
        ...
        subscriptionExpiredDesc: 'Your subscription has expired, please renew before importing subscription',
        trialPlanNotRenewable: 'Trial Plan Not Renewable',
        trialPlanNotRenewableDesc: 'This trial plan does not support renewal, please go to the store to purchase a regular plan',
        ...
        subscribeUrlHint: 'If copy button doesn\'t work, please select and right-click to copy',
