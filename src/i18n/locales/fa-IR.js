...
export default {
  ...
  dashboard: {
    ...
    subscriptionExpiredDesc: 'اشتراک شما منقضی شده است، لطفا قبل از وارد کردن اشتراک، آن را تمدید کنید',
    trialPlanNotRenewable: 'بسته آزمایشی قابل تمدید نیست',
    trialPlanNotRenewableDesc: 'این بسته آزمایشی از تمدید پشتیبانی نمی کند، لطفا به فروشگاه بروید و بسته عادی خریداری کنید',
    ...
    subscriptionUrlTitle: 'آدرس اشتراک',
    subscriptionUrlHint: 'اگر دکمه کپی کار نمی کند، آدرس را به صورت دستی انتخاب کرده و با کلیک راست کپی کنید',
