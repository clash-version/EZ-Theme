...
export default {
  ...
  dashboard: {
    ...
    subscriptionExpired: 'サブスクリプション期限切れ',
    subscriptionExpiredDesc: 'サブスクリプションの有効期限が切れています。更新してからインポートしてください',
    trialPlanNotRenewable: 'トライアルプランは更新不可',
    trialPlanNotRenewableDesc: 'このトライアルプランは更新できません。ストアで正式プランを購入してください',
    ...
    subscriptionUrlTitle: 'サブスクリプションURL',
    subscriptionUrlHint: 'コピーボタンが機能しない場合は、URLを手動で選択して右クリックでコピーしてください',
