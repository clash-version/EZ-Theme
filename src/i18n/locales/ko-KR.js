...
export default {
  ...
  dashboard: {
    ...
    subscriptionExpiredDesc: '구독이 만료되었습니다. 갱신 후 구독을 가져오세요',
    trialPlanNotRenewable: '체험 플랜 갱신 불가',
    trialPlanNotRenewableDesc: '이 체험 플랜은 갱신을 지원하지 않습니다. 스토어에서 정식 플랜을 구매하세요',
    ticketSupport: '티켓 지원',
    viewHelp: '도움말 보기',
    documentation: '사용 문서',
    ...
    subscriptionUrlTitle: '구독 URL',
    subscriptionUrlHint: '복사 버튼이 작동하지 않으면 주소를 직접 선택하고 우클릭하여 복사하세요',
