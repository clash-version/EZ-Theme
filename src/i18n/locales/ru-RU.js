...
export default {
  ...
  dashboard: {
    ...
    subscriptionExpiredDesc: 'Ваша подписка истекла, пожалуйста, продлите её перед импортом',
    trialPlanNotRenewable: 'Пробный план не продлевается',
    trialPlanNotRenewableDesc: 'Этот пробный план не поддерживает продление, пожалуйста, перейдите в магазин для покупки обычного плана',
    ...
    subscriptionUrlTitle: 'URL подписки',
    subscriptionUrlHint: 'Если кнопка копирования не работает, выделите адрес вручную и скопируйте правой кнопкой мыши',
