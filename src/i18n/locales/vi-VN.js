...
export default {
    ...
    dashboard: {
        ...
        subscriptionExpiredDesc: 'Đăng ký của bạn đã hết hạn, vui lòng gia hạn trước khi nhập đăng ký',
        trialPlanNotRenewable: 'Gói dùng thử không thể gia hạn',
        trialPlanNotRenewableDesc: 'Gói dùng thử này không hỗ trợ gia hạn, vui lòng vào cửa hàng để mua gói chính thức',
        ...
        subscriptionUrlTitle: 'URL đăng ký',
        subscriptionUrlHint: 'Nếu nút sao chép không hoạt động, hãy chọn thủ công địa chỉ và nhấp chuột phải để sao chép',
