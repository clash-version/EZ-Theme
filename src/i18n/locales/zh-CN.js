...
export default {
    ...
    dashboard: {
        ...
        subscriptionExpiredDesc: '您的订阅已过期，请先续费后再导入订阅',
        trialPlanNotRenewable: '试用套餐不支持续费',
        trialPlanNotRenewableDesc: '该试用套餐不支持续费，请前往商店购买正式套餐',
        ticketSupport: '工单支持',
        viewHelp: '查看帮助',
        documentation: '使用文档',
        pendingItems: '待处理事项',
        ...
        importTitle: '选择导入方式',
        subscribeUrl: '订阅链接',
        subscribeUrlHint: '如复制按钮无效，请手动选中链接后右键复制',
