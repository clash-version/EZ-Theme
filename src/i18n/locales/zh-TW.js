...
export default {
  ...
  dashboard: {
    ...
    subscriptionExpiredDesc: '您的訂閱已過期，請先續費後再匯入訂閱',
    trialPlanNotRenewable: '試用套餐不支援續費',
    trialPlanNotRenewableDesc: '該試用套餐不支援續費，請前往商店購買正式套餐',
    ticketSupport: '工單支援',
    viewHelp: '檢視幫助',
    documentation: '使用文件',
    pendingItems: '待處理事項',
    ...
    importTitle: '選擇匯入方式',
    subscribeUrl: '訂閱連結',
    subscribeUrlHint: '如複製按鈕無效，請手動選取連結後右鍵複製',
